            ...
            <div class="row">
                ...
                <div class="col-md-6 flex items-center ">
                    <form action="{{ url('/submit-kontak') }}" method="post">
                        @csrf
                        <input type="hidden" name="user_id" value="user_id_value"> <!-- Sesuaikan cara mendapatkan user_id -->
                        <input type="hidden" name="product_id" value="product_id_value"> <!-- Sesuaikan cara mendapatkan product_id -->
                        <input type="hidden" name="rating" value="5"> <!-- Contoh static rating, sesuaikan sesuai kebutuhan -->
                        <div class="mb-3">
